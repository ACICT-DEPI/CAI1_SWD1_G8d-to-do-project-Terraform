variable "aws_access_key" {
  type    = string
  default = ""  # Your AWS Access Key and dont pass it directly
}

variable "aws_secret_key" {
  type    = string
  default = ""  # Your AWS Secret Key and don't pass it directly
}
...
variable "rds_engine_version" {
  type    = string
  default = "8.0.35"  # Set the default MySQL engine version
}
...
variable "db_engine" {
  type    = string
  default = "mysql"  # Set the database engine to MySQL
}

variable "db_instance_class" {
  type    = string
  default = "db.t4g.micro"  # Use the Free Tier eligible instance type
}

variable "db_username" {
  type    = string
  default = "admin"  # Set your desired admin username
}

variable "db_name" {
  type    = string
  default = "mydatabase"  # Set your desired database name
}
